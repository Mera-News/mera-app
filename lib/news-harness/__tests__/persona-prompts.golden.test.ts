...
const PINNED_TOKENS: Record<string, [string, number]> = {
  ...
  CLOUD_TOPIC_GENERATION_SYSTEM_PROMPT: [CLOUD_TOPIC_GENERATION_SYSTEM_PROMPT, 3349],
  CLOUD_FACT_COMBO_TOPIC_GENERATION_SYSTEM_PROMPT: [
    CLOUD_FACT_COMBO_TOPIC_GENERATION_SYSTEM_PROMPT,
    3113,
  ],
  LOCAL_TOPIC_GEN_RULES_SNIPPET: [LOCAL_TOPIC_GEN_RULES_SNIPPET, 1948],
  LOCAL_TOPIC_GENERATION_SYSTEM_PROMPT: [LOCAL_TOPIC_GENERATION_SYSTEM_PROMPT, 2003],
  LOCAL_FACT_COMBO_TOPIC_GENERATION_SYSTEM_PROMPT: [
    LOCAL_FACT_COMBO_TOPIC_GENERATION_SYSTEM_PROMPT,
    1601,
  ],
