...
import { DEFAULT_HARNESS_CONFIG, type HarnessConfig } from '../core/config';
 ...
 * (0.4 / 0.6 / 0.8 / 1.1) land on their own cutoffs by construction, and any
 * continuous value lands in the band its magnitude implies.
 */
